...
type WatcherConfig struct {
	...
	ObservationDb    map[eth_common.Hash]*common.MessagePublication // If the watcher receives a re-observation request with a TxHash in this map, it will make the corresponding observation in this map.
